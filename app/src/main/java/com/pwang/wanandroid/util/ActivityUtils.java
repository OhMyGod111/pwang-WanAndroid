...
public final class ActivityUtils {
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(Utils.getAppContext(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(Utils.getAppContext(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(Utils.getAppContext(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(Utils.getAppContext(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, Utils.getAppContext(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @NonNull final Bundle options) {
        return startActivity(intent, Utils.getAppContext(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, Utils.getAppContext(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, Utils.getAppContext(), options);
    }
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(Utils.getAppContext(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(Utils.getAppContext(), clz));
    }
