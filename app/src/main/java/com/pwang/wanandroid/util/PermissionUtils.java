...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(Utils.getAppContext().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(Utils.getAppContext(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(Utils.getAppContext());
    }
    ...
    public static void requestWriteSettings(final SimpleCallback callback) {
        ...
        PermissionActivity.start(Utils.getAppContext(), PermissionActivity.TYPE_WRITE_SETTINGS);
    }
    ...
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        ...
        intent.setData(Uri.parse("package:" + Utils.getAppContext().getPackageName()));
    ...
    public static boolean isGrantedDrawOverlays() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            AppOpsManager aom = (AppOpsManager) Utils.getAppContext().getSystemService(Context.APP_OPS_SERVICE);
            if (aom == null) return false;
            int mode = aom.checkOpNoThrow(
                    "android:system_alert_window",
                    android.os.Process.myUid(),
                    Utils.getAppContext().getPackageName()
            );
            return mode == AppOpsManager.MODE_ALLOWED || mode == AppOpsManager.MODE_IGNORED;
        }
        return Settings.canDrawOverlays(Utils.getAppContext());
    }
    ...
    public static void requestDrawOverlays(final SimpleCallback callback) {
        ...
        PermissionActivity.start(Utils.getAppContext(), PermissionActivity.TYPE_DRAW_OVERLAYS);
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(Utils.getAppContext(), PermissionActivity.TYPE_RUNTIME);
    }
